...
const Button = ({ text, href }) => {
  ...
  return (
    ...
    <motion.div
      ...
      animate={controls}
      className="max-w-[500px] ease-in-out  text-white hover:bg-transparent hover:text-cyan-600 py-2 px-4 mx-10 my-10  bg-cyan-600 sm:ml-3 mt-5 sm:mt-0 border-2 border-cyan-600  transition-all duration-150 "
    >
