...
const TeamComponent = ({ title, description, link }) => {
  ...
  return (
    <Link href={link}>
      ...
      >
        <img
          src="https://www.mccmdclinic.org/wp-content/uploads/2020/01/Microscope.jpg"
          alt="Research Image"
          className="h-full object-cover w-full filter grayscale hover:filter-none transition-all duration-400"
        />
